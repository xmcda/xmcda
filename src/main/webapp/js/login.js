	...
	$.ajax({
		...
		alert("reponse serveur erreur  : " +data.error);
			if(data.error!==undefined){
				...
				window.location.href="/xmcdabis/index.jsp";
			}	
		},
		error:"error enregistrement"
	});
